find_program(ANTLR_COMMAND_LINE
             NAMES antlr antlr4)

if(NOT ANTLR_COMMAND_LINE)
  ...
  if(ANTLR_EXECUTABLE AND Java_JAVA_EXECUTABLE)
    set(ANTLR_COMMAND_LINE ${Java_JAVA_EXECUTABLE} -jar ${ANTLR_EXECUTABLE})
  endif()
endif()

if(ANTLR_COMMAND_LINE)
  execute_process(
      COMMAND ${ANTLR_COMMAND_LINE}
...
endif(ANTLR_COMMAND_LINE)

include(FindPackageHandleStandardArgs)
find_package_handle_standard_args(
    ANTLR
    REQUIRED_VARS ANTLR_COMMAND_LINE
